...
<div class="row">
    ...
    <div class="span3">
    <div><a href="{$ROOT_URL}/add.php" class="btn btn-success btn-block"><i class="icon-white icon-plus"></i> Add Yours</a></div>
    <br />
    <h4>Choose week</h4>
    <form id="setdate" action="{$ROOT_URL}/index.php" method="post">
